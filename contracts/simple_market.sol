...
contract EventfulMarket {
    ...
    event LogTrade(uint pay_amt, string indexed pay_gem,
                   uint buy_amt, string indexed buy_gem);
...
contract SimpleMarket is EventfulMarket, DSMath {
    ...
    function offer(uint pay_amt, string memory pay_gem, uint buy_amt, string memory buy_gem)
        public
        can_offer
        synchronized
        returns (uint id)
